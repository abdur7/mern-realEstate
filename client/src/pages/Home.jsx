        ...
        <div>
            <div className='flex flex-col gap-6 px-3 p-28 max-w-6xl mx-auto'>
                ...
                <div className='text-gray-400 text-xs sm:text-sm'>
                    ArkEstate is the best place to find your next perfect place to live
                    <br />
                ...
                <div>
                    <Link to={"/search"}>
                        <p className='text-blue-800 hover:underline text-xs sm:text-sm font-semibold'>Let's start now...</p>
                    </Link>
                </div>
            </div>
            <Swiper navigation>
            ...
            <div className='max-w-6xl mx-auto p-3 flex flex-col gap-8 my-10'>
                ...
                }
                {
                    saleListing && saleListing.length > 0 && (
                        <div>
                            <div className='my-3'>
                                <h2 className='text-2xl font-semibold text-slate-600'>Recent places on sale</h2>
