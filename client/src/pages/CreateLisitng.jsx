        ...
        <main className='p-4 max-w-4xl mx-auto'>
            ...
            <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-5' >
                ...
                <div className='flex flex-col flex-1'>
                    ...
                    <button disabled={loading || uploading} className='bg-slate-700 text-white p-3 uppercase mt-5 rounded-lg hover:opacity-80 disabled:opacity-50'>{loading ? "Creating..." : "Create Lisitng"} </button>
